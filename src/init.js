...
module.exports = function (files, basePath, jspm, client, emitter) {
  ...
  // overrides for system js config
  if (!jspm.systemJs) {
    jspm.systemJs = {}
  }
  // set default value for baseURL if empty
  if (!jspm.systemJs.baseURL) {
    jspm.systemJs.baseURL = 'base';
  }
  client.jspm.systemJs = jspm.systemJs;
